...
with st.expander("🐾 アップデート情報 (What's New) — バージョン 1.4.0 (最新)", expanded=False):
    st.markdown("""
    **【機能強化・最新アップデート情報】**
    * 📱 **スマートフォン特化「モバイルPINログインゲート」の新設**  
